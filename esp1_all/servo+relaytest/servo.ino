...
void loop() {
    ...
    if (myGamepad && myGamepad->isConnected()) {
        ...
        if (delayTombol <= 0){
          ...
          delayTombol += (myGamepad->a() * 50) + (myGamepad->b() * 50) + (myGamepad->y() * 50) + (myGamepad->x() * 50);
        ...
        // digitalWrite(RELAY4, tombol_b % 2 == 1 ? LOW : HIGH);

        // Program servo
        servo1.write(tombol_a % 2 == 1 ? 90 : 0);
        servo2.write(tombol_a % 2 == 1 ? 90 : 0);
        servo3.write(tombol_c % 2 == 1 ? 90 : 0);
